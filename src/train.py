...
class OolelTrainer:
    def __init__(self, args):
        ...
        # Flash Attention 2 significantly reduces memory during full fine-tuning
        # and is required when training with long sequences (>2k tokens).
        # bf16 is strongly recommended — fp16 can cause instabilities on Gemma.
    ...
    def train(self):
        ...
        training_args = TrainingArguments(
            ...
            hub_model_id=self.args.hub_model_id or None,
